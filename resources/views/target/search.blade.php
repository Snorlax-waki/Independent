            ...
            <div class="row row-cols-1 row-cols-md-6 g-4">
                <div class="col col-event">
                    <div class="card h-100">
                        <h6 class="card-header no-guetter text-center bg-secondary-subtle">誕生日</h6>
                ...
                <div class="col col-event">
                    <div class="card h-100">
                    <h6 class="card-header no-guetter text-center bg-secondary-subtle">クリスマス</h6>
                        <div class="card-body d-flex align-items-center ml-3">
                ...
                <div class="col col-event">
                    <div class="card h-100">
                    <h6 class="card-header no-guetter text-center bg-secondary-subtle">母の日</h6>
                        <div class="card-body d-flex align-items-center ml-3">
                ...
                <div class="col col-event">
                    <div class="card h-100">
                    <h6 class="card-header no-guetter text-center bg-secondary-subtle">父の日</h6>
                        <div class="card-body d-flex align-items-center ml-3">
                ...
                <div class="col col-event">
                    <div class="card h-100">
                    <h6 class="card-header no-guetter text-center bg-secondary-subtle">敬老の日</h6>
                        <div class="card-body d-flex align-items-center ml-3">
                ...
                <div class="col col-event">
                    <div class="card h-100">
                    <h6 class="card-header no-guetter text-center bg-secondary-subtle">その他</h6>
                        <div class="card-body d-flex align-items-center ml-3">
  ...
  <h5 class="card-header bg-dark-subtle">ステータスで探す</h5>
    <div class="card-body">
        <div class="row row-cols-1 row-cols-md-3">
            <div class="col">
                <div class="card h-60">
                    <h6 class="card-header no-guetter bg-secondary-subtle"></h6>
                        <div class="card-body">
